...
xz_1="./xz cpu2006docs.tar.xz 6643 055ce243071129412e9dd0b3b69a21654033a9b723d874b2015c774fac1553d9713be561ca86f74e4f16f22e664fc17a79f30caa5ad2c04fbc447549c2810fae 1036078272 11795472 4"
xz_2="./xz cld.tar.xz 1400 19cf30ae51eddcbefda78dd06014b4b96281456e078ca7c13e1c0c9e6aaea8dff3efb4ad6b0456697718cede6bd5454852652806a657bb56e07d61128434b474 536995164 539938872 8"

cactuBSSN="./cactuBSSN spec_ref.par"

lbm="./lbm 2000 reference.dat 0 0 200_200_260_ldc.of"

wrf="./wrf"

pop2="./pop2"

imagick="./imagick -limit disk 0 refspeed_input.tga -resize 817% -rotate -2.76 -shave 540x375 -alpha remove -auto-level -contrast-stretch 1x1% -colorspace Lab -channel R -equalize +channel -colorspace sRGB -define histogram:unique-colors=false -adaptive-blur 0x5 -despeckle -auto-gamma -adaptive-sharpen 55 -enhance -brightness-contrast 10x10 -resize 30% refspeed_output.tga"

nab="./nab 3j1n 20140317 220"

fotonik3d="./fotonik3d"

specrand="./specrand 1255432124 234923"

DIR_RESULTS="/home/ines/v1_1_9/aocc/results/speedup/base/"

DIR_AOCC="/home/ines/v1_1_9/aocc/"
...
for threads in 1 2 4 8 16 32 64 128; do
    ...
    taskset -c $cores $perf ./bwaves bwaves_1 < bwaves_1.in > ${DIR_RESULTS}outputs/bwaves_1.out 2>> ${DIR_RESULTS}perf/bwaves_1.err
    ...
    taskset -c $cores $perf ./bwaves bwaves_2 < bwaves_2.in > ${DIR_RESULTS}outputs/bwaves_2.out 2>> ${DIR_RESULTS}perf/bwaves_2.err
...
for threads in 1 2 4 8 16 32 64 128; do
    cd ${DIR_AOCC}628/base/th$threads
    cores=$(seq -s, 0 $((threads - 1)))
...
for threads in 1 2 4 8; do
    ...
    taskset -c $cores $perf ./sroms < ocean_benchmark3.in.x > ${DIR_RESULTS}outputs/ocean_benchmark3.log 2>> ${DIR_RESULTS}perf/sroms.err
